...
| 42  | Spelling (RU)    | "пропускют"                                                                                                 | "пропускают"                                                                                            | Пропущена буква "а" в глаголе                                               |
| 43  | Wording (RU/EN)  | "запишем в урлу квари параметрами" / "сохранять эти квери параметры" / "инретвал", "вылидные", "ппараметры" | "запишем в URL query-параметры" / "сохранять эти query-параметры" / "интервал", "валидные", "параметры" | Естественнее и технически точнее; повторяющийся паттерн и типичные опечатки |
| 44  | Spelling (RU)    | "бескнечные"                                                                                                | "бесконечные"                                                                                           | Переставлены буквы в слове                                                  |

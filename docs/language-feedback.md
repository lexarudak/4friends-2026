...
| 43  | Wording (RU/EN)  | "запишем в урлу квари параметрами" / "сохранять эти квери параметры" | "запишем в URL query-параметры" / "сохранять эти query-параметры" | Естественнее и технически точнее; повторяющийся паттерн     |

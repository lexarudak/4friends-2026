	...
	return (
		<div className={styles.page}>
			...
			<nav className={styles.nav}>
				...
				<Button href={PAGES.LOGIN} variant="outline" color="primary" size="md">
					Start →
				</Button>
			</nav>
			...
			<div className={styles.intro}>
				<p className={styles.introText}>
					4friends is a platform for competitions with friends. Make predictions
					for World Cup 2026 matches, earn points, follow the statistics and win!
					You decide what the prize pool will be and how it&apos;s distributed —
					we make sure the game is fair and all results are calculated on time.
				</p>
			</div>
			...
			<div className={styles.sections}>
				...
				<section className={styles.section}>
					...
					<p className={styles.sectionText}>
						After a match kicks off, you can see the bets made by other players.
						Match cards are color-coded too:
					</p>
					<ul className={styles.statusList}>
						<li className={styles.statusItem}>
							<span className={styles.dot} data-color="grey" />
				...
				<section className={styles.section}>
					<h2 className={styles.sectionTitle}>Point calculation — Group stage</h2>
					<p className={styles.sectionText}>
				...
				<section className={styles.section}>
					...
					<p className={styles.sectionText}>
						...
						breakdowns: guessed victories, exact scores, and average points per
						match.
					</p>
					<p className={styles.sectionText}>
